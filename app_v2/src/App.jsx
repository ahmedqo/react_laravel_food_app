...
import Page, { Home, Account, Dashboard, Menu, User, Cuisine, Product, Order, Reserve, NotFound } from "./pages";
import "./App.css";
		...
		<Wrapper>
			...
			<Routes>
				...
				<Route
					path="/reserves"
					element={
						<Page title="Liste De Reservations" isProtected={true}>
							<Account.Reserves />
						</Page>
					}
					exact
				...
				<Route
					path="/reserve/:_id"
					element={
						<Page title="Reservation" isProtected={true}>
							<Account.Reserve />
						</Page>
					}
					exact
				...
				<Route
					path="/admin/reserves"
					element={
						<Page title="Reservations" isProtected={true} isAdmin={true}>
							<Reserve />
						</Page>
					}
					exact
