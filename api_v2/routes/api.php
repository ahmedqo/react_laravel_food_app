...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::get('/reserves/me', [AuthController::class, 'reserves']);

    Route::get('/order/{id}', [OrderColtroller::class, 'show']);
    Route::post('/order/new', [OrderColtroller::class, 'store']);

    Route::get('/reserve/{id}', [ReserveController::class, 'show']);
    Route::post('/reserve/new', [ReserveController::class, 'store']);
});
...
Route::group(['middleware' => ['auth:api', 'admin'], 'prefix' => 'admin'], function () {
    ...
    Route::delete('/reserve/{id}', [ReserveController::class, 'destroy']);
